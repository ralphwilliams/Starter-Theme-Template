...
<div id="pageWrap" class="default-skin">
    <div id="contentWrap">
        ...
        <div class="content container">
            ...
            <div>
                <aside class="aside-pane pull-left" role="complementary">
                    <nav id="sideNavWrap">
                        <dnn:MENU ID="sideNav"  MenuStyle="sideNav" runat="server"></dnn:MENU>
                    </nav>
                    <div id="asidePane" runat="server" />
                </aside>
                <div id="contentPane" class="content-pane pull-right" role="main" runat="server" />
            </div>
        </div>
    </div>
    <footer>
